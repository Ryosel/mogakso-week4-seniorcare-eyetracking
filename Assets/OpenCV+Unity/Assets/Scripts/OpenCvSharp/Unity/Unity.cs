	...
	public class Unity {
		...
		public class TextureConversionParams
		{
			...
			public TextureConversionParams()
			{
				...
				FlipHorizontally = true; //카메라 좌우 반전
				RotationAngle = 0;
			}
			...
			/// Default value
			/// </summary>
			public static readonly TextureConversionParams Default = new TextureConversionParams() { FlipVertically = false, FlipHorizontally = true, RotationAngle = 0 }; //카메라 좌우 반전
		}
